...
bankData = os.path.join(r"C:\Users\bigmo\OneDrive\Desktop\Module 3\PyBank\Resources", "budget_data.csv")
...
with open(r'C:\Users\bigmo\OneDrive\Desktop\Module 3\PyBank\analysis\bankresults.txt', 'w') as f:
