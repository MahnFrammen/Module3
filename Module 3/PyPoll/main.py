...
pollData = os.path.join(r"C:\Users\bigmo\OneDrive\Desktop\Module 3\PyPoll\Resources", "election_data.csv")
...
with open(r'C:\Users\bigmo\OneDrive\Desktop\Module 3\PyPoll\analysis\pollresults.txt', 'w') as f:
